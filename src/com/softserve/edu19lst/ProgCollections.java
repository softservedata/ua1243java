package com.softserve.edu19lst;
...
//        System.out.println("Removed: another = " + list);
        */
        ...
        List<String> listDestination = new ArrayList<>(20);
        listDestination.add("0");
        listDestination.add("1");
        listDestination.add("2");
        listDestination.add("3");
        listDestination.add("4");
        listDestination.add("5");
        Collections.copy(listDestination, list);
        System.out.println("copy = " + listDestination);
